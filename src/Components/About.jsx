        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              Hello! I'm Prateet Tiwari, a full-stack web developer with a
              passion for building modern, responsive web applications. With a
              strong foundation in both front-end and back-end technologies, I
              strive to create seamless user experiences and efficient server-side
              solutions.
            </p>

            <p className="text-muted-foreground">
              I have experience working with various technologies including
              React, Node.js, and MongoDB. My goal is to leverage my skills to
